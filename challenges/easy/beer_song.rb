...
- program can generate the lyrics of 99 bottles of beer song
- verse of the song repeats for how many times specified
- during each verse, the number of bottles changes, depending on how many verses are left
- the last verse is different fromt the rest
